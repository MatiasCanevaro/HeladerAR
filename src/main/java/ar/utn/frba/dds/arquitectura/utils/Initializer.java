...
public class Initializer implements WithSimplePersistenceUnit {
    public static void init() {
            ...
            String IMAGE_URL_1 = "https://raw.githubusercontent.com/rxhack/productImage/main/2.jpg";
            String IMAGE_URL_2 = "https://raw.githubusercontent.com/rxhack/productImage/main/3.jpg";
            String IMAGE_URL_3 = "https://raw.githubusercontent.com/rxhack/productImage/main/4.jpg";

            String descripcion = "LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT. SED DO EIUSMOD TEMPOR INCIDIDUNT UT LABORE ET DOLO ";
        ...
        //===========================================TEST 5=========================================
                ...
                PuntoEstrategico puntoEstrategico1 = guardarPuntoEstrategicoEnCABA("Avenida Corrientes", "-34.60372222", "-58.3816", Arrays.asList("Avenida Corrientes", "1104", "1043"), repositorio);
                Heladera heladera1 = crearHeladera(modeloHeladera1, puntoEstrategico1, repositorio, repositorioHeladera);

                ModeloDeHeladera modeloHeladera2 = new ModeloDeHeladera("LG B200", 250, -5.0, 0.0);
                PuntoEstrategico puntoEstrategico2 = guardarPuntoEstrategicoEnCABA("Avenida Pueyrredón", "-34.5875555", "-58.3974", Arrays.asList("Avenida Pueyrredón", "2187", "1425"), repositorio);
                Heladera heladera2 = crearHeladera(modeloHeladera2, puntoEstrategico2, repositorio, repositorioHeladera);
        ...
        //===========================================TEST 6=========================================
            ...
            //===========================================TEST 7=========================================
                ...
                List<FormaDeColaboracion> formasDeColaboracion2 = Arrays.asList(
                        FormaDeColaboracion.DONACION_DE_DINERO,
                        FormaDeColaboracion.OFRECER_PRODUCTOS_Y_SERVICIOS
                );
                personaJuridica.setFormasDeColaboracion(formasDeColaboracion2);
                ...
                List<Oferta> ofertasAsociadas = nombresOfertas.stream()
                        .map(nombreOferta -> repositorio.buscarTodos("Oferta").stream()
                ...
                CentroDeLaCiudad centroDeCABA1 = repositorio.buscarPorNombre(
                        "Buenos Aires", "CentroDeLaCiudad", CentroDeLaCiudad.class);
                Ciudad ciudad1 = repositorio.buscarPorNombre("Buenos Aires", "Ciudad", Ciudad.class);

                Provincia provincia1 = repositorio.buscarPorNombre("Buenos Aires", "Provincia", Provincia.class);
                Direccion direccion1 = crearDireccion(
                        provincia1.getNombre(),
                        centroDeCABA1,
                        ciudad1.getNombre(),
                        Arrays.asList("Fraga", "1101", "1427", "2"),
                        repositorio);
                Rubro rubro = (Rubro) repositorio.buscarTodos("Rubro").stream()
                        .filter(r -> "Tecnología".equals(((Rubro) r).getNombre()))
                        .findFirst()
                        .orElse(null);
                personaJuridica.setRubro(rubro);
                personaJuridica.setDireccion(direccion1);


                repositorio.guardar(personaJuridica);

                Usuario usuario1 = new Usuario("admin-pj@gmail.com", "admin", TipoRol.PERSONA_JURIDICA, null, personaJuridica, null, null);
            ...
            //===========================================TEST 8=========================================
                ...
                List<PuntoEstrategico> puntosEstrategicos = Arrays.asList(
                        guardarPuntoEstrategicoEnCABA("Corrientes", "-34.6044422", "-58.3919939", Arrays.asList("Av. Corrientes", "1234", "1043"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Santa Fe", "-34.5750345", "-58.4355647", Arrays.asList("Av. Santa Fe", "5678", "1425"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Rivadavia", "-34.6096426", "-58.3997323", Arrays.asList("Av. Rivadavia", "2345", "1402"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Alvear", "-34.5962430", "-58.37500645516002", Arrays.asList("Marcelo T. Alvear", "590", "1005"),repositorio),
                        guardarPuntoEstrategicoEnCABA("de Mayo", "-34.6084164", "-58.3742021", Arrays.asList("Av. de Mayo", "543", "1080", "3"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Independencia", "-34.6171998", "-58.371718728841785", Arrays.asList("Avenida Independencia", "401", "1100", "2"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Lavalle", "-34.6024823", "-58.3793363", Arrays.asList("Calle Lavalle", "890", "1043"),repositorio),
                        guardarPuntoEstrategicoEnCABA("Pueyrredón", "-34.5990337", "-58.4039195", Arrays.asList("Av. Pueyrredón", "7654", "1120", "5"),repositorio)
                );

                Vianda vianda1 = guardarVianda("Arroz con Pollo", LocalDate.now().plusDays(5), 300.0, 500.0,repositorio);
                Vianda vianda2 = guardarVianda("Vegetales Asados", LocalDate.now().plusDays(7), 200.0, 400.0,repositorio);
                Vianda vianda3 = guardarVianda("Fideos con Tuco", LocalDate.now().plusDays(3), 350.0, 450.0,repositorio);

                for (int i = 0; i < puntosEstrategicos.size(); i++) {
                    ModeloDeHeladera modeloHeladera = modelosDeHeladera.get(i % modelosDeHeladera.size());
                    Heladera heladera = crearHeladera(modeloHeladera, puntosEstrategicos.get(i),repositorio, repositorioHeladera);
                ...
                for (String[] data : personasData) {
                    ...
                    PersonaFisica personaFisica1 = PersonaFisica.crearPersonaFisica(
                    ...
                    Email email1 = new Email(data[4]);
                    personaFisica1.setEmail(email1);
                    personaFisica1.setFechaNacimiento(LocalDate.parse(data[5], DateTimeFormatter.ofPattern("dd/MM/yyyy")));
                    personaFisica1.setPuntosAcumulados(Double.parseDouble(data[7]));

                    Provincia provincia2 = repositorio.buscarPorNombre("Buenos Aires", "Provincia", Provincia.class);
                    Ciudad ciudad2 = repositorio.buscarPorNombre("Buenos Aires", "Ciudad", Ciudad.class);
                    CentroDeLaCiudad centroDeCABA3 = repositorio.buscarPorNombre(
                            "Buenos Aires", "CentroDeLaCiudad", CentroDeLaCiudad.class);
                    Direccion direccion2 = crearDireccion(
                            ...
                            repositorio);
                    personaFisica1.setDireccion(direccion2);

                    List<FormaDeColaboracion> formasDeColaboracion3 = Arrays.asList(mapperImportador.formaDeColaboracion(data[6]));
                    personaFisica1.setFormasDeColaboracion(formasDeColaboracion3);

                    repositorioPersonaFisica.guardar(personaFisica1);

                    Usuario usuario3 = new Usuario(email1.getCorreoElectronico(), "password", TipoRol.PERSONA_FISICA, personaFisica1, null, null, null);
                ...
                Usuario usuario4 = new Usuario("admin@gmail.com", "admin", TipoRol.ADMIN, null, null, administrador, null);
                ...
                for (String[] data : tecnicosData) {
                    ...
                    repositorio.guardar(direccion3);
                    ...
                    Usuario usuario2 = new Usuario(data[10], data[11], TipoRol.TECNICO, null, null, null, tecnico);
                ...
                for (String[] tarjetaData : tarjetasData) {
                    ...
                    if (!personasFisicas.isEmpty()) {
                        PersonaFisica personaFisica2 = personasFisicas.get(0);  // Toma el primer elemento para evitar problemas con el índice
                        ...
                        personaFisica2.setTarjetas(new ArrayList<>());  // Inicializa la lista de tarjetas de la persona
                        tarjeta.setPersonaFisica(personaFisica2);
            ...
            //TODO no funciona guardar el id de solicitud
                ...
                List<Heladera> heladeras1 = (List<Heladera>) (List<?>) repositorioHeladera.buscarTodos("Heladera");
                Heladera heladera = heladeras1.get(0);
                PuntoEstrategico puntoEstrategico = heladera.getPuntoEstrategico();
                PuntoEstrategico puntoEstrategico3 = (PuntoEstrategico) repositorio.buscarPorId(puntoEstrategico.getId(), "PuntoEstrategico");
                PersonaFisica personaFisica2 = repositorioPersonaFisica.buscar(TipoDocumento.DNI, "12345678");
                ...
                //===========================================TEST 15=========================================
                List<Object> heladeras2 = repositorioHeladera.buscarTodos("Heladera");
                List<Object> personasFisicas = repositorio.buscarTodos("PersonaFisica");

                for (Object obj : personasFisicas) {
                    PersonaFisica personaFisica3 = (PersonaFisica) obj;

                    for (Object heladeraObj : heladeras2) {
                        ...
                        ConfiguracionDeTemperatura configuracionDeTemperatura = new ConfiguracionDeTemperatura(maxima
                                , minima, personaFisica3, LocalDateTime.now());

                        Heladera heladera3 = (Heladera) heladeraObj;
                        heladera3.setConfiguracionesDeTemperaturas(null);
                ...
                //===========================================TEST 16=========================================
                List<Object> personasFisicas5 = repositorio.buscarTodos("PersonaFisica");
                List<Object> cuestionarios = repositorio.buscarTodos("Cuestionario");
                for (Object obj : personasFisicas5) {
                    PersonaFisica personaFisica5 = (PersonaFisica) obj;
                    Cuestionario cuestionario3 = (Cuestionario) cuestionarios.get(0);
                    CuestionarioRespondido cuestionarioRespondido = new CuestionarioRespondido(cuestionario3, LocalDateTime.now());
                    repositorio.guardar(cuestionarioRespondido);
                    personaFisica5.setCuestionarioRespondido(cuestionarioRespondido);
                }

                //===========================================TEST 16=========================================
                List<Object> personasJuridicas = repositorio.buscarTodos("PersonaJuridica");
                List<Object> cuestionarios3 = repositorio.buscarTodos("Cuestionario");
                for (Object obj : personasJuridicas) {
                    PersonaJuridica personaJuridica3 = (PersonaJuridica) obj;
                    Cuestionario cuestionario4 = (Cuestionario) cuestionarios3.get(0);
                    CuestionarioRespondido cuestionarioRespondido = new CuestionarioRespondido(cuestionario4, LocalDateTime.now());
                    repositorio.guardar(cuestionarioRespondido);
                    personaJuridica3.setCuestionarioRespondido(cuestionarioRespondido);
                }
                ...
                Direccion direccion4 = crearDireccion(
                        provincia.getNombre(),
                        centroDeCABA,
                        ciudad.getNombre(),
                        Arrays.asList("Balcarce", "78", "1064", null),
                        repositorio);
                personaVulnerable.setDireccion(direccion4);
                repositorio.guardar(personaVulnerable);

                //===========================================TEST 19=========================================
                Cuestionario cuestionario6 = new Cuestionario();
                cuestionario6.setNombre("Cuestionario Persona Juridica");
                List<TipoRol> rol1 = new ArrayList<>();
                rol1.add(TipoRol.PERSONA_JURIDICA);
                cuestionario6.setRolesQueAcepta(rol1);
                repositorio.guardar(cuestionario6);

                Pregunta pregunta100 = new Pregunta("¿Cuál es la misión principal de su organización?", TipoPregunta.ABIERTA, null);
                repositorio.guardar(pregunta100);

                Pregunta pregunta200 = new Pregunta("¿Cómo se enteró de la existencia de este sistema?", TipoPregunta.UNICA, null);
                Opcion opcion100 = new Opcion("Internet");
                Opcion opcion200 = new Opcion("Recomendación de un familiar");
                Opcion opcion300 = new Opcion("Recomendación de un amigo");
                Opcion opcion400 = new Opcion("Otro");
                pregunta200.agregarOpcion(opcion100);
                pregunta200.agregarOpcion(opcion200);
                pregunta200.agregarOpcion(opcion300);
                pregunta200.agregarOpcion(opcion400);
                repositorio.guardar(opcion100);
                repositorio.guardar(opcion200);
                repositorio.guardar(opcion300);
                repositorio.guardar(opcion400);
                repositorio.guardar(pregunta200);

                Pregunta pregunta300 = new Pregunta("¿En qué rubros se desempeña su organización? (puede seleccionar más de una)", TipoPregunta.MULTIPLE, null);
                Opcion opcion500 = new Opcion("Tecnología");
                Opcion opcion600 = new Opcion("Salud");
                Opcion opcion700 = new Opcion("Otro");
                pregunta300.agregarOpcion(opcion500);
                pregunta300.agregarOpcion(opcion600);
                pregunta300.agregarOpcion(opcion700);
                repositorio.guardar(opcion500);
                repositorio.guardar(opcion600);
                repositorio.guardar(opcion700);
                repositorio.guardar(pregunta300);

                Pregunta pregunta400 = new Pregunta("¿Qué expectativas tiene de este sistema?", TipoPregunta.ABIERTA, null);
                repositorio.guardar(pregunta400);

                Pregunta pregunta500 = new Pregunta("Seleccione su tipo societario", TipoPregunta.UNICA, null);
                Opcion opcion800 = new Opcion("SA");
                Opcion opcion900 = new Opcion("SRL");
                Opcion opcion1000 = new Opcion("Otro");
                pregunta500.agregarOpcion(opcion800);
                pregunta500.agregarOpcion(opcion900);
                pregunta500.agregarOpcion(opcion1000);
                repositorio.guardar(opcion800);
                repositorio.guardar(opcion900);
                repositorio.guardar(opcion1000);
                repositorio.guardar(pregunta500);

                Pregunta pregunta600 = new Pregunta("¿Qué resultados le gustaría alcanzar con su participación en este sistema? (puede seleccionar más de una)", TipoPregunta.MULTIPLE, null);
                Opcion opcion1100 = new Opcion("Mejorar la calidad de vida de personas vulnerables");
                Opcion opcion1200 = new Opcion("Promover la responsabilidad social de la organización");
                Opcion opcion1300 = new Opcion("Establecer vínculos con otras entidades solidarias");
                Opcion opcion1400 = new Opcion("Generar conciencia sobre la problemática alimentaria");
                Opcion opcion1500 = new Opcion("Otro");
                pregunta600.agregarOpcion(opcion1100);
                pregunta600.agregarOpcion(opcion1200);
                pregunta600.agregarOpcion(opcion1300);
                repositorio.guardar(opcion1100);
                repositorio.guardar(opcion1200);
                repositorio.guardar(opcion1300);
                repositorio.guardar(opcion1400);
                repositorio.guardar(opcion1500);
                repositorio.guardar(pregunta600);

                cuestionario6.agregarPreguntas(List.of(pregunta100, pregunta200, pregunta300, pregunta400, pregunta500, pregunta600));
                repositorio.guardar(cuestionario6);
            }
        ...
        private static Direccion crearDireccion (String provincia, CentroDeLaCiudad centro, String
        nombreCiudad, List < String > direccion, Repositorio repositorio){
        ...
        private static Heladera crearHeladera (ModeloDeHeladera modelo, PuntoEstrategico puntoEstrategico, Repositorio repositorio, RepositorioHeladera repositorioHeladera){
            Heladera heladera = new Heladera(modelo, puntoEstrategico);

            cargarFechasYHoras(heladera);
        ...
        private static PuntoEstrategico guardarPuntoEstrategicoEnCABA (String puntoNombre, String latitud, String
        longitud, List < String > direccion, Repositorio repositorio){
            ...
            Direccion direccionCreada = crearDireccion(
                    provincia.getNombre(),
                    centroDeCABA,
                    ciudad.getNombre(),
                    direccion,
        ...
        private static Vianda guardarVianda (String nombreComida, LocalDate fechaCaducidad, Double calorias, Double peso, Repositorio repositorio){
            Vianda vianda = new Vianda();
        ...
        public static void cargarFechasYHoras (Heladera heladera){
